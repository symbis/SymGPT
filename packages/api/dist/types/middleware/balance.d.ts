 ...
 */
export declare function createSetBalanceConfig({ getBalanceConfig, Balance, }: BalanceMiddlewareOptions): (req: ServerRequest, res: ServerResponse, next: NextFunction) => Promise<void>;
